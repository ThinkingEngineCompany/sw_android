 ...
 * 相机预览页面
 */
public class CameraPreviewFragmentX extends Fragment implements View.OnClickListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private CameraPreviewPresenterX mPreviewPresenter;
    ...
    public CameraPreviewFragmentX() {
        mCameraParam = CameraParam.getInstance();
        mMainHandler = new Handler(Looper.getMainLooper());
        mPreviewPresenter = new CameraPreviewPresenterX(this);
    }
        ...
        mCameraTabView.addOnTabSelectedListener(new CameraTabView.OnTabSelectedListener() {
            ...
            public void onTabSelected(CameraTabView.Tab tab) {
                ...
                if (position == 0) {
                    ...
                    if (!isStorageEnable()) {
                        PermissionUtils.requestRecordSoundPermission(CameraPreviewFragmentX.this);
                    }
                    if (mBtnRecord != null) {
